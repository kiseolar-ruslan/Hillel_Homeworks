...
<form action="server.php" method="post" class="form" enctype="multipart/form-data">
    ...
    <fieldset class="container_appeal">
        ...
        <div class="file">
            ...
            <input type="file" name="file[]" id="file" class="person-file" multiple>
            <input type="file" name="fileOne" id="fileOne" class="person-file">
            <input type="file" name="fileTwo" id="fileTwo" class="person-file">
        </div>
    </fieldset>
